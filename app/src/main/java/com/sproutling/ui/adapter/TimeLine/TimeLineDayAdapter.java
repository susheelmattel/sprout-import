...
public class TimeLineDayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    TimeLineDayAdapter(Context context) {
        mContext = context;
    }

    @Override
    public int getItemCount() {
        if (mEventListData.getLastNightEventList().size() > 0) {
            return mEventListData.getEventList().size() + 1;
        } else {
