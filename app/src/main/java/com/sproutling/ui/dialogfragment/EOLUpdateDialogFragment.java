...
public class EOLUpdateDialogFragment extends DialogFragment {
    ...
    public static EOLUpdateDialogFragment newInstance(String url, String title, String message, String buttonTxt) {
        EOLUpdateDialogFragment fragment = new EOLUpdateDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        shAlertView.setButton2ClickListener(mOnButton2ClickListener);
    ...
    private View.OnClickListener mOnButton2ClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            dismiss();
        }
