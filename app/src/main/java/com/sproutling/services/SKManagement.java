...
public class SKManagement {
    ...
    public static SSManagement.UserAccountInfo updateAlert(String accessToken, String userId, JSONObject body) throws IOException, JSONException, SSException {
        return SSManagement.updateAlert(accessToken, userId, body);
    }
    ...
    public static List<SSManagement.SSEvent> listEventsByType(String token, String childId, String eventType) throws IOException, JSONException, SSException {
        return SSManagement.listEventsByChild(token, childId, eventType);
    }
    ...
    public static boolean deleteEventById(String token, String eventId) throws IOException, JSONException, SSException {
        return SSManagement.deleteEventById(token, eventId);
    }
    ...
    public static SSManagement.EOLData getEOLData() throws IOException, JSONException, SSException {
        return SSManagement.getEOLData();
    }

    public static void uploadChildPhoto(String childId,File file){
