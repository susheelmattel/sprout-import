 ...
 */
open class ProductSettings(@SerializedName("name") var name: String = "my_settings",
                           ...
                           @SerializedName("other_settings") var otherSettings: OtherSettings?, @SerializedName("id") var ID: String? = null) {
}