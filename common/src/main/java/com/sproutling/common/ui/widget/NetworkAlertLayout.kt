...
class NetworkAlertLayout : RelativeLayout {
    ...
    private var mProgressBarLayout: RelativeLayout? = null
    private var mNetworkAlertBLayout: RelativeLayout? = null
    ...
    private fun init(context: Context) {
        LayoutInflater.from(context).inflate(R.layout.dialog__network_alert_layout, this)
        ...
        mNetworkAlertBLayout = findViewById(R.id.dialog_layout)
    }
    ...
    fun setLayoutVisibility(shouldShowProgress: Boolean) {
        if(shouldShowProgress){
            mProgressBarLayout?.visibility = View.VISIBLE
            mNetworkAlertBLayout?.visibility = View.GONE
        } else{
            mProgressBarLayout?.visibility = View.GONE
            mNetworkAlertBLayout?.visibility = View.VISIBLE
        }
    }
}
